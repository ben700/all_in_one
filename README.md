...
- 만능앱을 바탕으로 자신이 원하는 기능만 골라서, 앱을 출시 할 수 있습니다.

# 참가 신청

- [만능앱 개발 단톡방](https://open.kakao.com/o/gNs8gvid)에서 "참가신청합니다. 깃허브 아이디: xxxx" 와 같이 적어주시면 됩니다.
...
- 개발에 참여하고 싶습니다. 어떻게 하면 되나요?
  - [개발자 문서](https://github.com/thruthesky/all_in_one/blob/main/docs/DEVELOPER_GUIDE.md)를 보세요.

- 세미나에 참여하고 싶습니다. 어떻게하면 되나요?
  - 매주 일요일 오후 4시에 세미나를 진행합니다. 세미나 참여를 하기 위해서는 줌(Zoom)을 설치 후 [만능앱 세미나 방](https://us02web.zoom.us/j/82973973102?pwd=a3FabVN3NythSm5aeHJubDJtalVkdz09)으로 들어오시면 됩니다.
...
- 2021년 7월 25일 현재 총 8차 세미나가 진행되었으며, 계속 진행될 예정입니다.

- 스터디 방향 논의
  - 초기 세미나에서 기존의 팀멤버들이 새로운 멤버를 위해서, 본 프로젝트 개발에 적응을 할 수 있도록 가이드를 해 주어야 하고,
...
- 공유 가능한 위젯 생성
  ...
  - 플러터의 경우,
    - lib 폴더
    - 또는 pubspec.yaml 에 등록된 패키지
    에 있는 소스 코드를 사용 할 수 있다.
